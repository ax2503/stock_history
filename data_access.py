...
#This function is probably unnecessary. I can just run the start and finish dates on each table.
...
def splitYears(startdate, enddate) :
  yearlist =[]
  for year in range(int(startdate[:4]), int(enddate[:4]) +1) :
